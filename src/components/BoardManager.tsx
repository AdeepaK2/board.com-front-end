          ...
          {view === 'save' && (
            <div className="save-view">
              ...
              <div className="button-group">
                <button onClick={handleSaveBoard} disabled={loading || !boardName.trim()} className="btn-primary">
                    ...
                    <div key={board.boardId} className="board-card">
                      <div className="board-info">
                        ...
                        <div className="board-meta">
                          <span><User size={14} /> {board.savedBy}</span>
                          <span><Calendar size={14} /> {formatDate(board.savedAt)}</span>
                          <span>🎨 {board.shapeCount} shapes</span>
                        </div>
                      </div>
                      <div className="board-actions">
                        <button onClick={() => handleLoadBoard(board.boardId)} className="btn-load" title="Load">
                          <FolderOpen size={18} />
                        </button>
                        <button onClick={() => handleExportBoard(board.boardId)} className="btn-export" title="Export">
                          <Download size={18} />
                        </button>
                        <button onClick={() => handleDeleteBoard(board.boardId, board.boardName)} className="btn-delete" title="Delete">
                          <Trash2 size={18} />
                        </button>
                      </div>
                    </div>
